...
public class srimangol extends JFrame implements ActionListener{
    ...
    public srimangol(Login login_Obj, CustomerInfo CustomerInfo_obj,pPack pPack_obj)
	{
        super("Srimangol");
        ...
        icon1=new ImageIcon(getClass().getResource("Graphics/1x/sr1.jpg"));
        imLabel1=new JLabel(icon1);
        imLabel1.setBounds(7,5,icon1.getIconWidth(),icon1.getIconHeight());

        icon2=new ImageIcon(getClass().getResource("Graphics/1x/sr2.jpg"));
        imLabel2=new JLabel(icon2);
        imLabel2.setBounds(5,280,icon2.getIconWidth(),icon2.getIconHeight());

        icon3=new ImageIcon(getClass().getResource("Graphics/1x/sr3.jpg"));
        ...
        l1=new JLabel("Want to visit Srimangol?");
        l1.setFont(new Font("Calibri",Font.BOLD,30));
        l1.setBounds(420,10,350,30);
        ...
        if(e.getSource()==rbt1){
            ...
            try{
                if(!rbt1.isSelected()&&!rbt2.isSelected()&&!rbt3.isSelected()){
                    ...
                    setVisible(false);
                    new srimangolPay(login_Obj,CustomerInfo_obj,pPack_obj,this);
                }
    ...
    public static void main(String[]args){
        new srimangol(new Login(), new CustomerInfo(new Login()), new pPack(new Login(), new CustomerInfo(new Login())));
    }
}
