...
public class coxe extends JFrame implements ActionListener{
    ...
    public coxe(Login login_Obj, CustomerInfo CustomerInfo_obj,pPack pPack_obj){
        super("Cox's Bazar");
        ...
        icon1=new ImageIcon(getClass().getResource("Graphics/1x/cx1.jpg"));
        imLabel1=new JLabel(icon1);
        imLabel1.setBounds(7,5,icon1.getIconWidth(),icon1.getIconHeight());

        icon2=new ImageIcon(getClass().getResource("Graphics/1x/cx2.jpg"));
        imLabel2=new JLabel(icon2);
        imLabel2.setBounds(5,280,icon2.getIconWidth(),icon2.getIconHeight());

        icon3=new ImageIcon(getClass().getResource("Graphics/1x/cx3.jpg"));
        ...
        l1=new JLabel("Want to visit Cox's Bazar?");
        ...
        if(e.getSource()==rbt1){
            ...
            try{
                if(!rbt1.isSelected()&&!rbt2.isSelected()&&!rbt3.isSelected()){
                    ...
                    setVisible(false);
                     new coxePay(login_Obj,CustomerInfo_obj,pPack_obj,this);
                }
   ...
   public static void main(String[]args){
        new coxe(new Login(), new CustomerInfo(new Login()), new pPack(new Login(), new CustomerInfo(new Login())));
    }
}
